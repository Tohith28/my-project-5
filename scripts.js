...
form.addEventListener('submit', function (e) {
    ...
    const apiID = `0399920e4f0f813c4a12b38cfde2945f`;
    // API URL
...
//                 iconElement.innerHTML = `<img src="https://openweathermap.org/img/w/${data.weather[0].icon}.png" alt="${data.weather[0].description}">`;
//             })
//             .catch((error) => {
